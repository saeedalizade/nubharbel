        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12">
                    ...
                    {{ Breadcrumbs::render('article',$articleList) }}
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    <div class="post">
                                        ...
                                        <div class="post-desc">
                                            <div class="post-title">
                                                <h5><a href="{{ url('article/'.$post['id']) }}">{{ $post['title'] }}</a></h5>
                                            </div>
                                            <p>{{ strip_tags ($post['description']) }}</p>
                                            <a class="post-btn" href="{{ url('article/'.$post['id']) }}">بیشتر بخوانید
