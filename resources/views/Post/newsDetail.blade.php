        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12">
                    <h1 class="mb-3"><span class="text-theme">{{ $data['newsDetail']['title'] }}</span></h1>
                    {{ Breadcrumbs::render('newsDetail',$data['newsDetail']) }}
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="left-side">
                            <div class="post-image">
                                <img class="img-fluid w-100"
                                     src="{{ asset ('img/post/Large/'.$data['newsDetail']['img']) }}" alt=""/>
                                @php $Created = new Verta($data['newsDetail']['created_at']);@endphp
                        ...
                        <div class="blog-details">
                            <div class="post-desc">
                                <div class="post-title">
                                    <h3 class="mb-3">{{$data['newsDetail']['title']}}</h3>
                                </div>
                                <div class="post-queto pos-r mt-5">
                                    <span><i class="fas fa-quote-left"></i></span>
                                    <h5 class="mb-0 text-capitalize font-italic">
                                        {{ strip_tags($data['newsDetail']['description']) }}
                                    </h5>
                                </div>
                                <p>

                                    {{ strip_tags($data['newsDetail']['content']) }}
                            ...
                            <div class="media-holder mt-5">
                                ...
                                @foreach($data['commentNews'] as $comment)
                                    <div class="media">
                                        <img class="img-center ml-3 img-comment-with-100" alt="image"
                                             src="{{ asset('img/avatar_profile/'.$comment->UserProfile['avatar']) }}"/>
